...
public class Unit {
    ...
    void draw(float[] m) {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mHandleBitmap[0]);//이미지를 모두 할당한뒤 처리하면 최종화면만 출력
        //onDrawRender로  호출될 시 객체의 이미지를 다시 바인드 해줌으로써 해결
